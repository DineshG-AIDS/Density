...
//       <svg
//         className="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-yellow-500"
...
//             </div>
//             <div>
//               <p className="font-semibold tracking-wide text-white">Service</p>
//               <ul className="mt-2 space-y-2">
//                 <li>
//                   <a
//                     href="/"
...
//               className="transition-colors duration-300 text-deep-purple-100 hover:text-teal-accent-400"
//             >
//               <svg viewBox="0 0 30 30" fill="black" className="h-6">
