...
const ShuffleHero = () => {
  return (
    <section className="w-full px-8  py-12 grid grid-cols-1 md:grid-cols-2 items-center gap-12 max-w-6xl mx-auto">
      <div>
        <span className="block mb-4  md:text-xl text-white text-lg  text-center">
          FrontEnd Magician
        </span>
        <h3 className="text-5xl tracking-wider md:text-6xl text-yellow-500 font-semibold text-center">
          Dinesh G
        </h3>
        <p className="text-base md:text-lg tracking-wider p-4 border-yellow-600 border-2 rounded-2xl text-white my-4 md:my-8">
          <span className="text-yellow-600 text-2xl">&quot;</span> Lorem ipsum
          dolor sit amet consectetur adipisicing elit. Harum optio distinctio
          quibusd
          <span className="text-yellow-600 text-2xl">&quot;</span>
        </p>
        <div className="flex justify-center">
          <button className="bg-yellow-500 rounded-full text-black font-medium py-2 px-4  transition-all hover:bg-yellow-300 active:scale-95 flex items-center gap-4">
            <svg
